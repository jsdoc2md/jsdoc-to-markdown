...
<table>
  <caption>This is a summary of the examples</caption>
  <thead>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p>A module exposing two methods and an inner class. The docs are generated by <code>$ jsdoc2md --template jsdoc2md/README.hbs --sort-by scope,kind lib/*.js</code>. The main template is overridden by `README.hbs` which contains this handlebars block:</p>
<pre><code>
