  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p>The identifiers are sorted by scope (instance, static, etc) then kind (property, method, etc.). The main template is overridden by `README.hbs`, the API docs are inserted by this `dmd` block:</p>
<pre><code>
