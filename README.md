...
| Project | Notes |
| ======= | ===== |
| [handbrake-js](https://github.com/75lb/handbrake-js) | A module exposing two methods and an inner class. The docs are generated by `$ jsdoc2md --template jsdoc2md/README.hbs --sort-by scope,kind lib/*.js`. The main template is overridden by `README.hbs` which contains this handlebars block: <pre><code>
...
*  (exports an object with inner class)
